...
- elicitation, specification, operationalization, validation, monitoring, revision, and governance fields;
- evidence snippets;
- gap summary;
- quality assessment fields.

The purpose of this formatting is to make the evidence easier for reviewers to inspect directly on GitHub.
