...
- `data/search_screening/Fairness_RE_SLR_Search_Demonstration_Steps.csv` — step-by-step search demonstration aligned with the handwritten search-log instruction.
